...
inits[:Cost_of_fossil_fuel_for_non_el_use_G__per_y] = inits[:Cost_of_fossil_fuel_for_non_el_use_G__per_y] ~ (inits[:Demand_for_fossil_fuel_for_non_el_use_Mtoe_per_y] *  p[Traditional_cost_of_fossil_fuel_for_non_el_use___per_toe] ) /1000
...
inits[:Govmnt_purchases_G__per_y] = inits[:Govmnt_purchases_G__per_y] + inits[:Govmnt_investment_in_public_capacity_G__per_y]
