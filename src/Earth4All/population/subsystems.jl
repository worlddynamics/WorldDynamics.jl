...
function population(; name, params=_params, inits=_inits, tables=_tables, ranges=_ranges)
    ...
    eqs = [
        ...
        #
        D(Deaths_Mp_per_y1) ~ (10 / LE_at_60_y) * ((Passing_60_Mp_per_y - Deaths_Mp_per_y1) - Deaths_Mp_per_y1 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y2) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y1 - Deaths_Mp_per_y2) - Deaths_Mp_per_y2 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y3) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y2 - Deaths_Mp_per_y3) - Deaths_Mp_per_y3 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y4) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y3 - Deaths_Mp_per_y4) - Deaths_Mp_per_y4 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y5) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y4 - Deaths_Mp_per_y5) - Deaths_Mp_per_y5 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y6) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y5 - Deaths_Mp_per_y6) - Deaths_Mp_per_y6 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y7) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y6 - Deaths_Mp_per_y7) - Deaths_Mp_per_y7 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y8) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y7 - Deaths_Mp_per_y8) - Deaths_Mp_per_y8 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y9) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y8 - Deaths_Mp_per_y9) - Deaths_Mp_per_y9 * LE_at_60_y / 10),
        D(Deaths_Mp_per_y) ~ (10 / LE_at_60_y) * ((Deaths_Mp_per_y9 - Deaths_Mp_per_y) - Deaths_Mp_per_y * LE_at_60_y / 10),
        #
