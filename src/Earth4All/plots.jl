...
variables_mt = [
    ...
    (Average_wellbeing_index_1, 0, 3, " Average Wellbeing Index"),
    (Social_tension_1, 0, 2, "Social Tension"),
    (Observed_warming_deg_C, 0, 3, "Observed warming"),
    (GDP_G_dollar_per_y, 0, 400000, "GDP"),
    (Inequality_1, 0, 1.6, "Inequality"),
]
plotvariables(solution, (t, 1980, 2100), variables_mt; title="1. Main trends - World 1980 to 2100")
...
variables_inq_index = [
    (Inequality_index_1980_equal_1, 0, 1.6, "Giant Leap"),
]
