...
variables_hf_vensim = [
    (Population_below_15_k__per_p_per_y_Mp,    0, 10000,  "Population below 15k"),
...
variables_w = [
    (Average_wellbeing_from_disposable_income__1_,    0, 8,  "From disposable income"),
    (Average_wellbeing_from_inequality__1_,    0, 1.2, "From inequality"),
    (AVERAGE_WELLBEING_INDEX__1_,    0, 2.4, " Average Wellbeing Index"),
    (Average_wellbeing_from_public_spending__1_, 0, 8,   "From public spending"),
    (Average_wellbeing_from_progress__1_, 0, 1.2,   "From progress"),
    (Average_wellbeing_from_global_warming__1_, 0, 1.2,   "From global warming"),
]
plotvariables(solution,(t, 1980, 2100), variables_w; title="4. Wellbeing (Giant Leap scenario)")

variables_inq_index = [
    (INEQUALITY_INDEX__19801_,    0, 1.6,  "Giant Leap"),
]
plotvariables(solution,(t, 1980, 2100), variables_inq_index; title="Inequality Index")


variables_tran_pay = [
    (Transfer_payments_G__per_y,    0, 70000,  "Giant Leap"),
]
plotvariables(solution,(t, 1980, 2100), variables_tran_pay; title="Transfer Payments G/y")


variables_globalsti = [
    (Wellbeing_effect_of_participation__1_,    0, 2,  "Wellbeing Giant Leap"),
    (Social_tension__1_,    0, 2,  "Social Tension Giant Leap"),
    ]
