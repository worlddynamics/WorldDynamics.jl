...
Passing_40_Mp_per_y ~ delay_n(Passing_20_Mp_per_y, 20, Passing_40_in_1980_Mp_per_y, Order),
...
Forcing_from_other_gases_W_per_m2 ~ interpolate(Time, ((1980,0.18),(2000,0.36),(2020,0.39),(2050,0.37),(2100,0))),
Basic_income_tax_rate_owners__1_ ~ min(1, Income_tax_rate_owners_in_1980__1_ + ramp(( Income_tax_rate_owners_in_2022__1_ - Income_tax_rate_owners_in_1980__1_ ) / 42, 1980, 2022) + ramp(( Goal_for_income_tax_rate_owners__1_ - Income_tax_rate_owners_in_2022__1_ ) / 78, 2022, 2100) ),
...
OWeoLOC__1_ ~ IfElse.ifelse(Time>2022, 1 + sOWeoLOC_0 * ( Observed_warming_deg_C / Observed_warming_in_2022_deg_C - 1 ), 1),
D(Perceived_unemployment_CB__1_) ~ (Unemployment_rate__1_ - Perceived_unemployment_CB__1_) /  Unemployment_perception_time_CB_y,
OWeoCOC__1_ ~ IfElse.ifelse(Time>2022, 1 + sOWeoCOC_0 * ( Observed_warming_deg_C / Observed_warming_in_2022_deg_C - 1 ), 1),
...
Passing_60_Mp_per_y ~ delay_n(Passing_40_Mp_per_y, 20, Passing_60_in_1980_Mp_per_y, Order),
...
Deliveries_Gu_per_y ~ ( ( Effective_purchasing_power_G__per_y / Price_per_unit___per_u ) / ( Delivery_delay___index__1_ / DDI_in_1980_y ) ) * IfElse.ifelse(Time > 1984, Pink_noise_in_sales__1_, 1),
...
Fraction_of_CO2_sources_with_CCS__1_ ~ Fraction_of_CO2_sources_with_CCS_in_2022__1_ + ramp(( Goal_for_fraction_of_CO2_sources_with_CCS__1_ - Fraction_of_CO2_sources_with_CCS_in_2022__1_ ) / Introduction_period_for_policy_y , 2022 , 2022 + Introduction_period_for_policy_y),
Cost_of_nuclear_electricity_G__per_y ~ Nuclear_electricity_production_TWh_per_y * Cost_of_nuclear_el___per_kWh,
Cropland_expansion_multiplier__1_ ~ IfElse.ifelse(Time>2022,  1 - SSP2_land_management_action_from_2022___1_ * ramp((1 - 0 )/78, 2022, 2100), 1),
...
Pink_noise_in_sales__1_ ~ random_pink_noise(Normal__1_ ,STD_in_fluctuation_around_normal__1_, Sampling_time_y, 1),
...
kg_N2O_emission_per_kg_fertiliser ~ kg_N2O_per_kg_fertilizer_in_1980 *   exp(-(Rate_of_decline_in_N2O_per_kg_fertiliser_1_per_y)  * ( Time - 1980)) *IfElse.ifelse(Time>2022, exp(-(Extra_rate_of_decline_in_N2O_per_kg_fertilizer_from_2022_1_per_y)  * ( Time - 2022)), 1),
Extra_normal_LPR_from_2022__1_ ~ ramp(Goal_for_extra_normal_LPR__1_ / Introduction_period_for_policy_y, 2022, 2022 + Introduction_period_for_policy_y),
...
OWeoTFP ~ IfElse.ifelse(Time>2022, 1 + sOWeoTFP_0 * ( Observed_warming_deg_C / Observed_warming_in_2022_deg_C - 1 ), 1),
Passing_20_Mp_per_y ~ delay_n(Births_Mp_per_y, 20, Passing_20_in_1980_Mp_per_y, Order),
...
Fertility_multiplier__1_ ~ IfElse.ifelse(SSP2_family_action_from_2022___1_ > 0,  IfElse.ifelse(Time>2022, 1 + ramp((Max_fertility_multiplier__1_ - 1 )/78, 2022, 2100), 1),  1),
...
Desired_renewable_electricity_share__1_ ~ Renewable_el_fraction_in_1980__1_ + ramp(( Renewable_el_fraction_in_2022__1_ - Renewable_el_fraction_in_1980__1_ ) / 42, 1980, 2022) + ramp(( Goal_for_renewable_el_fraction__1_ - Renewable_el_fraction_in_2022__1_ ) / Introduction_period_for_policy_y, 2022, 2022 + Introduction_period_for_policy_y ),
State_capacity__fraction_of_GDP_ ~ Value_of_public_services_supplied_G__per_y / GDP_G__per_y,
Income_from_commons_from_2022_G__per_y ~ National_income_G__per_y * IfElse.ifelse(Time>2022,  ramp( Goal_for_extra_income_from_commons__share_of_NI_ / Introduction_period_for_policy_y , 2022, 2020 + Introduction_period_for_policy_y) , 0),
...
Deaths_Mp_per_y ~ delay_n(Passing_60_Mp_per_y, LE_at_60_y, Dying_in_1980_Mp_per_y, Order),
Demand_pulse_2020_25__1_ ~ 0 + Pulse_height__1_* pulse(2020, 5),
...
Fraction_regenerative_agriculture__1_ ~ ramp( Goal_for_fraction_regenerative_agriculture__1_ / Introduction_period_for_policy_y , 2022, 2020 + Introduction_period_for_policy_y),
Demand_for_fossil_fuel_for_non_el_use_before_NE_Mtoe_per_y ~ ( Population_Mp * Traditional_per_person_use_of_fossil_fuels_for_non_el_use_before_EE_toe_per_p_per_y  * exp(-Normal_increase_in_energy_efficiency_1_per_y * ( Time - 1980 ))) / Extra_energy_productivity_index_20221,
D(Govmnt_debt_G_) ~ Govmnt_new_debt_G__per_y-Cancellation_of_debt_G__per_y-Govmnt_payback_G__per_y,
Food_sector_productivity_index__19801_ ~ exp(ROC_in_food_sector_productivity_1_per_y * ( Time - 1980)) * IfElse.ifelse(Time>2022, exp( Extra_ROC_in_food_sector_productivity_from_2022_1_per_y* ( Time - 2022)), 1),
...
Direct_air_capture_of_CO2_GtCO2_per_y ~ IfElse.ifelse(Time>2022,  ramp((Direct_air_capture_of_CO2_in_2100_GtCO2_per_y ) / Introduction_period_for_policy_y , 2022, 2022 + Introduction_period_for_policy_y) , 0 ),
...
N2O_forcing_per_ppm_W_per_m2_per_ppm ~ interpolate(Time, ([(1980,0)-(2100,2)],(1980,0.43),(2000,0.64),(2010,0.73),(2020,0.8),(2100,1))),
New_forestry_land_Mha_per_y ~ Old_growth_removal_Mha_per_y * ( 1 - Fraction_cleared_for_grazing__1_),
Extra_taxes_for_TAs_from_2022_G__per_y ~ IfElse.ifelse(Time>2022, Extra_cost_of_TAs_from_2022_G__per_y * Fraction_of_extra_TA_cost_paid_by_extra_taxes__1_ , 0 ),
...
Natural_N2O_emissions_GtN2O_per_y ~ interpolate(Time, ((1980,0.009),(2020,0.009),(2099.27,0))),
...
CO2_effect_on_land_yield__1_ ~ IfElse.ifelse(Time>2022, 1 + sCO2CeoACY_0 * ( CO2_concentration_in_atm_ppm / CO2_concentration_in_2022_ppm - 1 ), 1),
...
Extra_pension_age_y ~ ramp(( Goal_for_extra_pension_age_y - Extra_pension_age_in_2022_y ) / Introduction_period_for_policy_y, 2022, 22022 + Introduction_period_for_policy_y),
...
CO2_forcing_per_ppm_W_per_m2_per_ppm ~ interpolate(Time, ((1980,0.0032),(1990,0.0041),(2000,0.0046),(2020,0.0051),(2100,0.006))),
tCO2_per_toe ~ 2.8*exp(ROC_in_tCO2_per_toe_1_per_y * (Time -1980)),
...
Fraction_new_red_meat__1_ ~ ramp( Goal_for_fraction_new_red_meat__1_ / Introduction_period_for_policy_y , 2022, 2022 + Introduction_period_for_policy_y),
...
xExtra_cost_of_TAs_as_share_of_GDP__1_ ~ xExtra_TA_cost_in_2022__share_of_GDP_ + ramp((xExtra_TA_cost_in_2100__share_of_GDP_-xExtra_TA_cost_in_2022__share_of_GDP_)/78, 2022, 2022 + 78),
...
CH4_forcing_per_ppm_W_per_m2_per_ppm ~ interpolate(Time, ((1980,0.82),(2000,0.94),(2020,1.01),(2100,1.1))),
...
Warming_effect_on_land_yield__1_ ~ IfElse.ifelse(Time>2022, 1 + sOWeoACY_0 * ( Observed_warming_deg_C / Observed_warming_in_2022_deg_C - 1 ), 1),
...
Demand_for_electricity_before_NE_TWh_per_y ~ ( Population_Mp  * Traditional_per_person_use_of_electricity_before_EE_MWh_per_p_per_y  * exp(-Normal_increase_in_energy_efficiency_1_per_y * ( Time - 1980))) / Extra_energy_productivity_index_20221,
...
Off_balance_sheet_govmnt_inv_in_PIS__share_of_GDP_ ~ IfElse.ifelse(Time>2022, Unconventional_stimulus_in_PIS_from_2022__share_of_GDP_, 0),
...
Cancellation_of_debt_G__per_y ~ pulse(2022, 1)* Govmnt_debt_G_ * Fraction_of_govmnt_debt_cancelled_in_2022_1_per_y,
...
Extra_cost_of_Energy_Turnaround_as_share_of_GDP__1_ ~ IfElse.ifelse(Time>2022, ( Cost_of_energy_G__per_y - Traditional_cost_of_energy_G__per_y ) / GDP_G__per_y, 0),
...
Fertilizer_productivity_index__19801_ ~ exp(ROC_in_fertilizer_productivity_1_per_y * ( Time - 1980)),
D(Ice_and_snow_cover_excl_G_A_Mkm2) ~ -Melting_Mha_per_y,
kg_CH4_emission_per_kg_crop ~ kg_CH4_per_kg_crop_in_1980  *   exp(-(Rate_of_decline_in_CH4_per_kg_crop_1_per_y)  * ( Time - 1980)) *IfElse.ifelse(Time>2022, exp(-(Extra_rate_of_decline_in_CH4_pr_kg_crop_after_2022_1_per_y)  * ( Time - 2022)), 1),
Fossil_capacity_up_time_kh_per_y ~ Demand_for_fossil_electricity_TWh_per_y / Fossil_electricity_capacity_GW,
Natural_CH4_emissions_GtCH4_per_y ~ interpolate(Time, ((1980,0.19),(2020,0.19),(2100,0.19))),
...
Nuclear_capacity_GW ~ interpolate(Time, ((1980,75),(2000,310),(2020,310),(2098.9,310))),
...
Off_balance_sheet_govmnt_inv_in_PUS__share_of_GDP_ ~ IfElse.ifelse(Time>2022, 0.01 + Unconventional_stimulus_in_PUS_from_2022__share_of_GDP_, 0.01),
...
Fraction_new_electrification__1_ ~ Fraction_new_electrification_in_1980__1_ + ramp((Fraction_new_electrification_in_2022__1_ - Fraction_new_electrification_in_1980__1_ ) / 42, 1980, 2022) + ramp(( Goal_for_fraction_new_electrification__1_ - Fraction_new_electrification_in_2022__1_ ) / Introduction_period_for_policy_y , 2022, 2022 + Introduction_period_for_policy_y),
...
Land_erosion_multiplier__1_ ~ IfElse.ifelse(Time>2022,  1 - SSP2_land_management_action_from_2022___1_ *  ramp((1 - 0 )/ 78, 2022, 2100), 1),
...
Extra_general_tax_from_2022_G__per_y ~ IfElse.ifelse(Time>2022, Extra_general_tax_rate_from_2022__1_ + Extra_empowerment_tax_from_2022__share_of_NI_ + Extra_pension_tax_from_2022__share_of_NI_, 0) * National_income_G__per_y,
...
Life_expectancy_multipler__1_ ~ IfElse.ifelse(SSP2_family_action_from_2022___1_ > 0,  IfElse.ifelse(Time>2022, 1 + ramp((Max_life_expectancy_multiplier__1_ - 1 )/78, 2022, 2100), 1),  1),
...
OWeoLoCO2 ~ IfElse.ifelse(Time>2022, 1 + sOWeoLoCO2_0 * ( Observed_warming_deg_C / Observed_warming_in_2022_deg_C - 1 ), 1),
Lambda ~ 1 - Kappa,
...
Imported_ROTA_1_per_y ~ IfElse.ifelse(Time>2022, max(0,  Max_imported_ROTA_from_2022_1_per_y *  ( 1 - 1 * ( GDP_per_person_k__per_p_per_y / GDPpp_of_technology_leader_k__per_p_per_y - 1 )) ),  0),
...
Goal_for_fraction_of_govmnt_budget_to_workers__1_ ~ Fraction_transferred_in_1980__1_ + IfElse.ifelse(Time>2022, Extra_transfer_of_govmnt_budget_to_workers__1_, 0),
...
Biofuels_use_Mtoe_per_y ~ interpolate(Time, ((1980,0),(1990,0),(2000,0),(2020,0),(2100,0))),
Cost_of_grid_G__per_y ~ Electricity_production_TWh_per_y * Transmission_cost___per_kWh,
Extra_fertility_reduction__1_ ~ ramp( Goal_for_extra_fertility_reduction__1_ / Introduction_period_for_policy_y , 2022, 2022 + Introduction_period_for_policy_y),
Forest_absorption_multipler__1_ ~ IfElse.ifelse(Time>2022, 1 + SSP2_land_management_action_from_2022___1_* ramp((Max_forest_absorption_multiplier__1_ - 1)/78, 2022, 2100), 1),
...
Warming_effect_on_life_expectancy__1_ ~ IfElse.ifelse(Time>2022, max(0, 1 + sOWeoLE_0 *  ( Observed_warming_deg_C / Observed_warming_in_2022_deg_C - 1 )), 1 ),
Crop_waste_reduction__1_ ~ ramp( Goal_for_crop_waste_reduction__1_ / Introduction_period_for_policy_y , 2022, 2022 + Introduction_period_for_policy_y ),
...
Domestic_rate_of_technological_advance_1_per_y ~ ( Domestic_ROTA_in_1980_1_per_y + (IfElse.ifelse(Time>2022, Extra_domestic_ROTA_from_2022_1_per_y, 0)) *  ( 1 +  sSCeoROTA_0 * ( State_capacity__fraction_of_GDP_ / State_capacity_in_1980__fraction_of_GDP_  - 1 ))),
...
Old_growth_removal_rate_multiplier__1_ ~ IfElse.ifelse(Time>2022,  1 - SSP2_land_management_action_from_2022___1_ * ramp((1 - 0 )/78, 2022, 2100), 1),
