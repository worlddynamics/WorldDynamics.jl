...
Cropland_expansion_multiplier__1_ ~ IfElse.ifelse(Time>2022,  1 - SSP2_land_management_action_from_2022___1_ * ramp(t,(1 - 0 )/78, 2022, 2100), 1),
...
Fertility_multiplier__1_ ~ IfElse.ifelse(SSP2_family_action_from_2022___1_ > 0,  IfElse.ifelse(Time>2022, 1 + ramp(t,(Max_fertility_multiplier__1_ - 1 )/78, 2022, 2100), 1),  1),
...
Income_from_commons_from_2022_G__per_y ~ National_income_G__per_y * IfElse.ifelse(Time>2022,  ramp(t,Goal_for_extra_income_from_commons__share_of_NI_ / Introduction_period_for_policy_y , 2022, 2020 + Introduction_period_for_policy_y) , 0),
...
Direct_air_capture_of_CO2_GtCO2_per_y ~ IfElse.ifelse(Time>2022,  ramp(t,(Direct_air_capture_of_CO2_in_2100_GtCO2_per_y ) / Introduction_period_for_policy_y , 2022, 2022 + Introduction_period_for_policy_y) , 0 ),
...
Land_erosion_multiplier__1_ ~ IfElse.ifelse(Time>2022,  1 - SSP2_land_management_action_from_2022___1_ *  ramp(t,(1 - 0 )/ 78, 2022, 2100), 1),
...
Life_expectancy_multipler__1_ ~ IfElse.ifelse(SSP2_family_action_from_2022___1_ > 0,  IfElse.ifelse(Time>2022, 1 + ramp(t,(Max_life_expectancy_multiplier__1_ - 1 )/78, 2022, 2100), 1),  1),
...
Forest_absorption_multipler__1_ ~ IfElse.ifelse(Time>2022, 1 + SSP2_land_management_action_from_2022___1_* ramp(t,(Max_forest_absorption_multiplier__1_ - 1)/78, 2022, 2100), 1),
...
Old_growth_removal_rate_multiplier__1_ ~ IfElse.ifelse(Time>2022,  1 - SSP2_land_management_action_from_2022___1_ * ramp(t,(1 - 0 )/78, 2022, 2100), 1),
