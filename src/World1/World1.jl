...
function fig_4(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2100), _variables_4(); title="W1-7/5-4", showaxis=false, showlegend=false,kwargs...)
end
...
function fig_5(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2100), _variables_5(); title="W1-7/5-5", showaxis=false, showlegend=false,kwargs...)
end
...
function fig_6(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2000), _variables_6(); title="W1-7/5-6", showaxis=false, showlegend=false,kwargs...)
end
...
function fig_7(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2100), _variables_7(); title="W1-7/5-7", showaxis=false, showlegend=false,kwargs...)
end
...
function fig_8(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2100), _variables_8(); title="W1-7/5-8", showaxis=false, showlegend=false,kwargs...)
end
...
function fig_9(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2100), _variables_9(); title="W1-7/5-9", showaxis=false, showlegend=false,kwargs...)
end
...
function fig_10(; kwargs...)
    ...
    plotvariables(sol, (t, 1900, 2100), _variables_10(); title="W1-7/5-10", showaxis=false, showlegend=false,kwargs...)
end
