...
lmf0 = interpolate(fpc0 / params[:sfpc], lmft, lmfts) # lines 8-10 page 167
...
le0 = params[:len] * lmf0 * lmhs0 * lmp0 * lmc0 # lines 6-7 page 167
fm0 = interpolate(le0, fmt, fmts) # lines 36-37 page 168
mtf0 = params[:mtfn] * fm0 # lines 34-35 page 168
frsn0 = 0.82 # lines 50-52 page 168
sfsn0 = interpolate(iopc0, sfsnt, sfsnts)  # lines 46-49 page 168
dcfs0 = params[:dcfsn] * frsn0 * sfsn0 # lines 43-45 page 168
...
br0 = tf0 * pop0 * params[:ffw] / params[:rlt] # lines 28-31 page 168
